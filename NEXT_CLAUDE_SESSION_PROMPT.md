...
3. **Do not modify anything yet.** Do not start Wave 2, do not deploy, do not
   re-run Wave 1 QA, do not touch DNS or Supabase settings.
4. Report back a short summary of your understanding: project purpose, stack,
   deployment state, current commit, what is complete (Wave 1) and what is
   next (Wave 2 — Time & Leave, not started).
5. Then wait for the Owner/GPT Wave 2 implementation prompt before doing any
   implementation work.
